...
class PoseTwistIMUFuser(Node):
    ...
    def __init__(self):
        ...
        self.pose_sub = Subscriber(self, PoseWithCovarianceStamped, '/wamv/inekf_odom_correction/pose_corrected')
        self.twist_sub = Subscriber(self, TwistStamped, '/wamv/inekf_odom_correction/twist_corrected')
        ...
        # Publishers
        self.pose_pub = self.create_publisher(PoseStamped, '/gt_pose_corrected', 100)
